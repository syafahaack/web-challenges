...
function hasAnimal(animals, animalName) {
  // Convert the input animal name to lowercase
  const lowerCaseAnimalName = animalName.toLowerCase();
  // Convert all animal names in the array to lowercase and check if the lowercased input is included
  return animals
    .map((animal) => animal.toLowerCase())
    .includes(lowerCaseAnimalName);
}
...
// Function to check whether a specific animal is part of the zoo
function hasAnimal(animals, animalName) {
  // Convert the input animal name to lowercase
  const lowerCaseAnimalName = animalName.toLowerCase();
  // Convert all animal names in the array to lowercase and check if the lowercased input is included
